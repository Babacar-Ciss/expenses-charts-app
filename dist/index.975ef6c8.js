...
currentIndex = _dataJson.findIndex((data)=>data.day === date);
...
charts.forEach((chart, index)=>{
    ...
    chart.addEventListener("mouseover", ()=>{
        ...
        if (currentIndex === index) return;
            ...
            chart.insertAdjacentHTML("beforeend", `<p> $${_dataJson[index].amount} </p>`);
...
_dataJson.forEach((data)=>arrayExpense.push(data.amount));
...
},{}]},["ShInH","8lqZg"], "8lqZg", "parcelRequire3485")
